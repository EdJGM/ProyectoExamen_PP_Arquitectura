...
public class Electrodomestico {
    ...
    public Electrodomestico(int idElectrodomestico, String codigo, String nombre, 
                           String descripcion, String marca, double precioVenta, 
    ...
    public String toString() {
        return nombre + " - " + marca + " ($" + String.format("%.2f", precioVenta) + ")";
    }
}