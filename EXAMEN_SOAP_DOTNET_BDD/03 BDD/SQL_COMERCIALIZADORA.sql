-- =============================================
-- SCRIPT SQL - COMERCIALIZADORA (MODIFICADO)
...
CREATE TABLE electrodomestico (
    id_electrodomestico INT IDENTITY(1,1) PRIMARY KEY,
...
PRINT '- Tablas de factura, detalle_factura y credito_aprobado creadas';